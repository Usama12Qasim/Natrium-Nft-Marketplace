...
//             let NFT1 = ListNFT1[0];
//             let Seller1 = NFT1.args.seller;
//             let TokenURI = NFT1.args.tokenUri;
//             let TokenId1 = NFT1.args.tokenID;
//             let HostContract1 = NFT1.args.hostContract;
//             let Nft1Price = NFT1.args.nftPrice;
//             let Listed1 = NFT1.args.isListed;
...
//             //     let BuyNFT2 = await deployedNatriumMarketPlaceContract.queryFilter("TransferNft");
//             //     let BuyNft2 = BuyNFT2[1];
//             //     let Seller = BuyNft2.args.from;
//             //     let Buyer2 = BuyNft2.args.to;
...
//             await deployedNatriumTicketingContract.connect(minter1).approve(deployedNatriumMarketPlaceContract.target, 3); 
//             await deployedNatriumTicketingContract.connect(minter1).approve(deployedNatriumMarketPlaceContract.target, 4); 
//             await deployedNatriumTicketingContract.connect(minter1).approve(deployedNatriumMarketPlaceContract.target, 5);
...
//             // console.log("Token id",tokenid, " Ticket Type",tickettype, "Uri", tokenuri, "Price",price,"Expire", expiry);
...
//             await deployedNatriumTicketingContract.connect(buyer3).approve(deployedNatriumMarketPlaceContract.target, 0);
...
//             await deployedNatriumMarketPlaceContract.getNft(0, buyer3.address);
